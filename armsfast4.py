...
# We don't need to check numbers that contain only zeros and/or ones
# once we have two or more digits. The way the combinations are
# sorted, the highest number used will be in the last position. We
# can check that so we don't check (for example) things like 00000
# and 11111. The way things work, this does not save any appreciable
# time.
#       if c[-1] < 2:
#           continue
